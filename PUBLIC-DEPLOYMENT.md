# 🦁 LEONE CLI — Public Deployment Guide

Quick guide for pushing LEONE CLI to GitHub and publishing to NPM.
...
- [ ] GitHub account: https://github.com/netelite
...
- 14 methodology files (CC BY-SA 4.0)
- CLI code (MIT License)
- Full AI governance system
- Dual licensing (MIT + CC BY-SA 4.0)
...
|-----------|---------|---------------|
| **CLI Code** | MIT | Open source, must credit NETELITE |
| **Methodology** | CC BY-SA 4.0 | Can use commercially, must share improvements, must credit NETELITE |
| **LEONE Name** | Trademark ™ | NETELITE brand |
| **Copyright** | © 2026 NETELITE | NETELITE ownership |
